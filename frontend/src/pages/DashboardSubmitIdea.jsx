...
const DashboardSubmitIdea = () => {
  ...
  <div>
    ...
    <Input
      type="number"
      min={1}
      max={100} // Increased max for better flexibility
      value={teamSize}
      onChange={(e) => setTeamSize(Number(e.target.value))}
      className="w-full bg-background border-border focus:ring-cyan-500"
  ...
  <div>
    ...
    <Input
      ...
      onChange={(e) => setAvgTeamExperience(Number(e.target.value))}
      className="w-full bg-background border-border focus:ring-pink-500"
      placeholder="e.g. 2.5"
    />
  </div>
</div>
